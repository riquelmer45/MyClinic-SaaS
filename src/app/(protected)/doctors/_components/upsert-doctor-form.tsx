...
const UpsertDoctorForm = ({
  ...
  return (
    <DialogContent>
      ...
      <DialogDescription>
        {doctor
          ? "Edite as informações desse médico abaixo."
          : "Preencha as informações do novo médico abaixo."}
      </DialogDescription>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          {(form.formState.errors.availableFromTime ||
            form.formState.errors.availableToTime) && (
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      do médico e todas as consultas agendadas.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
